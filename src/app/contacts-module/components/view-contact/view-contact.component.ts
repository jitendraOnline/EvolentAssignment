...
export class ViewContactComponent implements OnInit {
  ...
  displayedColumns = ["firstName", "email", "phoneNumber", "status", "action"];
  displayedColumnsHeaders = [
    { name: "Name", filed: "firstName" },
    { name: "Email", filed: "email" },
    { name: "Phone Number", filed: "phoneNumber" },
    { name: "Status", filed: "status" },
  ];
  ...
  ngOnInit() {
    this.contactSerivce
      .getAllContact()
      .subscribe((userList: ContactModel[]) => {
